...
const Map<String, Map<String, String>> _table = {
  'pt': {
    ...
    'sheet.error': 'Não consegui carregar agora. Puxe pra atualizar.',
    ...
    'safe_arrival.action': 'Avisar que cheguei',
    ...
    'safe_arrival.drawer_hint': 'Mande pra alguém que você chegou bem',
  ...
  'en': {
    ...
    'sheet.error': "Couldn't load right now. Pull to refresh.",
    ...
    'safe_arrival.action': 'Let someone know I arrived',
    ...
    'safe_arrival.drawer_hint': 'Send a contact that you got there safely',
  ...
  'es': {
    ...
    'sheet.error': 'No se pudo cargar ahora. Desliza para actualizar.',
    ...
    'safe_arrival.action': 'Avisar que llegué',
    ...
    'safe_arrival.drawer_hint': 'Avísale a alguien que llegaste bien',
    'favorites.title': 'Favoritos',
